...
fields, and the real cuts avoid external requests.  Yet 36,251 hypothetical
cuts split model requests and are unsound for continuation, while thousands of
discarded oracle interactions prevent an unchanged-world claim.  A local bridge
study further illustrates that decision and path equivalence can separate, but
it remains outside the public headline evidence until its commit-bound bundle
is published.
