...
The executable specification makes those distinctions checkable.  Effect
...
discarded oracle interactions prevent an unchanged-world claim.  In a second
study, 66.7\% decision agreement coexists with 0\% path agreement.
