...
and verifies zero inherited external calls under an authenticated conformance
environment.  A local executive study further illustrates that decision and
path equivalence can separate, but it remains outside the public headline
