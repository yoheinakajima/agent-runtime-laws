...
Writing a configuration as $\langle s,Q,A,O,L_{\mathrm{ret}},T\rangle$, the two load-bearing
...
\frac{
 ...
 \langle s,Q,A,O,L_{\mathrm{ret}},T\rangle
 \rightarrow_{\sigma}
 \langle s',Q\setminus e,A',O,L_{\mathrm{ret}}\mathbin{+}e,T\rangle
}
...
\frac{
 ...
 \langle s,Q,A,O,L_{\mathrm{ret}},T\rangle
 \rightarrow_{\sigma}
 \langle s,Q',A\setminus a,O',L_{\mathrm{ret}},T\mathbin{+}(b,e)\rangle
}
