...
fresh-environment attestation.  This property deliberately does not assert that
a retrospectively discarded source suffix left the original world unchanged.
\end{definition}
...
scope.  Supporting a narrower $\Omega$ requires explicit observable tags; the
