...
The receipt binds the parent, cut, observation $P$, prefix hash, environment
premise, inherited effect identities, and zero-reexecution obligations.  In
particular, a cut through Requested is refused unless an explicit recovery
policy changes the requested property.
